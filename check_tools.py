...
def detect_tools(user_query: str, tools: List[Dict[str, str]]) -> Dict[str, Any]:
    ...
    system_prompt = f"""You are a tool detection system. Analyze the user's query and decide if one of the following tools is required:
{tools_info}
...
if __name__ == "__main__":
    ...
    # # Example 3: Run the test harness with 100 generated queries.
    print("\nRunning 100-query test harness for tool detection and execution...")
    test_tool_detection_system(100)
